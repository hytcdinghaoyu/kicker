...
<form action="<?php echo U('AdminPublic/doLogin');?>" method="post">
...
<div class="form-item">
 ...
 <span class="img"><img src="<?php echo U('AdminPublic/verify');?>" onclick="this.src='<?php echo U('AdminPublic/verify','','',false);?>-'+new Date().getTime();" /></span></div>
