...
<script type="text/javascript">
		var checkUrl = '<?php echo U("Member/Reg/checkUser",'','');?>'
</script>
			...
			<div class="inner register_inner">
				...
				<div class="register_panel" id="register_panel">
					...
					<div id="email_register" class="login_form email_register_form">
						<div class="noform">
							<ul>
								<form method="post" action="<?php echo U('Member/Reg/AddUser');?>" id="regform">
							...
							<div class="ext_links"><a href="<?php echo U("Member/login/index");?>"><i class="arrow"></i>立即登录</a></div>
						</div>
					</div>				
				</div>				
			</div>
