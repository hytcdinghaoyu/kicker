		...
		<div class="inner clear">
			...
			<div class="one_step addr_step">
					...
					<div class="step_main" id="addressUl">
						<div class="clearfix step_radio_wrap"></div>
						<div class="add_addr">	
						...
						<div class="new_address" style="display:none">
							...
							<input type="submit" class="add_input" value="确定">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
								<tbody>
									...
									<tr>
										<th><em>*</em><label for="region_id">省：</label></th> 
										<td><select name="region_id" id="region_id" data-value="0"><option value="0">--请选择--</option><option value="1">北京市</option><option value="9">上海市</option><option value="19">广东省</option><option value="2">天津市</option><option value="27">重庆市</option><option value="10">江苏省</option><option value="11">浙江省</option><option value="6">辽宁省</option><option value="13">福建省</option><option value="28">四川省</option><option value="3">河北省</option><option value="17">湖北省</option><option value="18">湖南省</option><option value="15">山东省</option><option value="23">陕西省</option><option value="4">山西省</option><option value="8">黑龙江省</option><option value="16">河南省</option><option value="12">安徽省</option><option value="20">海南省</option><option value="7">吉林省</option><option value="21">广西省</option><option value="29">贵州省</option><option value="30">云南省</option><option value="22">甘肃省</option><option value="31">西藏藏族自治区</option><option value="25">青海省</option><option value="24">新疆维吾尔自治区</option><option value="14">江西省</option><option value="5">内蒙古自治区</option><option value="26">宁夏回族自治区</option></select><em>市：</em><select name="city_id" id="city_id" data-value="0"><option value="0">--请选择--</option></select><em>区县：</em><select name="district_id" id="district_id" data-value="0"><option value="0">--请选择--</option></select><em id="address_error" class="error_em"></em>
										<p class="note">若列表中没有您需要的区县地址信息，请将您的区县地址填入街道地址中</p> </td> 
									</tr>
									<tr>
